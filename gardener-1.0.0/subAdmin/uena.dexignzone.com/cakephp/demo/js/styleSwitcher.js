...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		if(this.value === 'dark'){
			jQuery(".nav-header .logo-abbr").attr("src", "images/logo.html");
			jQuery(".nav-header .logo-compact").attr("src", "images/logo-text.html");
			jQuery(".nav-header .brand-title").attr("src", "images/logo-text.html");
			
			setCookie('logo_src', 'images/logo.html');
			setCookie('logo_src2', 'images/logo-text.html');
		}else{
			jQuery(".nav-header .logo-abbr").attr("src", "images/logo-white.html");
			jQuery(".nav-header .logo-compact").attr("src", "images/logo-text-white.html");
			jQuery(".nav-header .brand-title").attr("src", "images/logo-text-white.html");
			
			setCookie('logo_src', 'images/logo-white.html');
			setCookie('logo_src2', 'images/logo-text-white.html');
		}
	...
	jQuery('#theme_direction').on('change',function(){
		if(html.attr('dir') === "rtl"){
			jQuery('.main-css').attr('href',asset_base_url+'css/style-rtl.css');
		}else{
			jQuery('.main-css').attr('href',asset_base_url+'css/style.css')
		}
	});
